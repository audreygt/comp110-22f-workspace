...
def customer_checking(points: int) -> int:
    ...
    while customer_rating < 4 and turn_number < 3:
        if customer_rating == 1:
            ...
            print("Here is the customer's comment: \U0001F4AC Your work is complete #$%!.")
            if turn_number < 3: 
        ...
        if customer_rating == 2:
            ...
            print("Here is the customer's comment: \U0001F4AC You must have had a Dook education in computer science.")
            if turn_number < 3: 
                print(f"Pass the {FIXING_DEVICE} to the next customer for their rating.")
            if turn_number != 3:
                points += 5
        if customer_rating == 3:
            ...
            print("Here is the customer's comment: \U0001F4AC You must have an NC Stink education in computer science.") 
            if turn_number < 3: 
                print(f"Pass the {FIXING_DEVICE} to the next customer for their rating.")
            if turn_number != 3:
                points -= 34
        ...
        if customer_rating == 4:
            ...
            print("Here is the customer's comment: \U0001F4AC This worker must have attended the computer science program at UNC but may have slept in some of the lectures.")
...
def greet() -> None:
    ...
    input("Press enter.\n")
    print("Near the end of your work shift, the device will be rated by the customers in which your points will then turn into your paycheck for the end of the day.")
    input("Press enter.\n")
